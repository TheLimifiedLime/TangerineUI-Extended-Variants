...
1. **Copy the files** from [this folder](https://github.com/TheLimifiedLime/TangerineUI-for-Mastodon/tree/main/mastodon/app/javascript/styles/) to your Mastodon themes directory `app/javascript/styles/`:
...
app/
  javascript/
    styles/
      ...
      tangerineui-green.scss                          | **new**
        tangerineui/                                  | **new**
          layout-single-column.scss                   | **new**
        tangerineui-purple/                           | **new**
          layout-single-column.scss                   | **new**
        tangerineui-green/                            | **new**
          layout-single-column.scss                   | **new**
```

2. **Add Tangerine UI to `themes.yml`**. To make Tangerine UI available in your users's settings, you need to add a new line to [`config/themes.yml`](https://github.com/mastodon/mastodon/blob/main/config/themes.yml). Here we're adding 3 new lines, one for Tangerine UI, another for Tangerine UI's purple variant, and another for the the fork's Tangerine UI's green variant:
...
Your users should now be able to choose '*Tangerine UI*' and '*Tangerine UI (Purple)*' and '*Tangerine UI (Green)*' as their site theme:
...
2. **Copy the files** from [this folder](https://github.com/TheLimifiedLime/TangerineUI-for-Mastodon/tree/main/mastodon/app/javascript/skins/vanilla/) to your Glitch-soc skins directory `app/javascript/skins/vanilla/`:
